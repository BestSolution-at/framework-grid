 ...
 * <ul>
 *   <li>{@link at.bestsolution.framework.grid.personsample.model.person.impl.CountryImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CountryImpl extends MinimalEObjectImpl.Container implements Country {
	...
	protected EClass eStaticClass() {
		return PersonPackage.Literals.COUNTRY;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PersonPackage.COUNTRY__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PersonPackage.COUNTRY__NAME:
				return getName();
		}
