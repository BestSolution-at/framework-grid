 ...
 * <ul>
 *   <li>{@link at.bestsolution.framework.grid.personsample.model.person.impl.RootImpl#getPersons <em>Persons</em>}</li>
 *   <li>{@link at.bestsolution.framework.grid.personsample.model.person.impl.RootImpl#getCountries <em>Countries</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RootImpl extends MinimalEObjectImpl.Container implements Root {
	...
	protected EClass eStaticClass() {
		return PersonPackage.Literals.ROOT;
	}
	...
	public EList<Person> getPersons() {
		if (persons == null) {
			persons = new EObjectContainmentEList<Person>(Person.class, this, PersonPackage.ROOT__PERSONS);
		}
		return persons;
	}
	...
	public EList<Country> getCountries() {
		if (countries == null) {
			countries = new EObjectContainmentEList<Country>(Country.class, this, PersonPackage.ROOT__COUNTRIES);
		}
		return countries;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PersonPackage.ROOT__PERSONS:
				return ((InternalEList<?>)getPersons()).basicRemove(otherEnd, msgs);
			case PersonPackage.ROOT__COUNTRIES:
